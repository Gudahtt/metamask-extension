...
describe('MetaMask Browser Extension', function () {
  it('can send a simple transaction from one account to another', async () => {
    await withFixtures('simple-send', async ({driver}) => {
      ...
      await driver.clickElement('#app-content > div > div.main-container-wrapper > div > div.page-container__footer > header > button.button.btn-secondary.btn--large.page-container__footer-button')
